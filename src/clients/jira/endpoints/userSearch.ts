...
export class UserSearch {
  ...
  async findBulkAssignableUsers<T = unknown>(
  ...
  async findAssignableUsers<T = unknown>(
    parameters: FindAssignableUsers | undefined,
    callback: Callback<T>
  ): Promise<void>;
  /**
   * Returns a list of users that can be assigned to an issue. Use this operation to find the list of users who can be assigned to:
  ...
  async findUsersWithAllPermissions<T = unknown>(
  ...
  async findUsersForPicker<T = FoundUsers>(
  ...
  async findUsers<T = unknown>(
    parameters: FindUsers | undefined,
    callback: Callback<T>
  ): Promise<void>;
  /**
   * Returns a list of users that match the search string and property.
  ...
  async findUsersByQuery<T = PageBeanUser>(
   ...
   *
   * `is assignee of PROJ AND [propertyKey].entity.property.path is "property value"` */
  async findUserKeysByQuery<T = PageBeanUserKey>(
  ...
  async findUsersWithBrowsePermission<T = unknown>(
    parameters: FindUsersWithBrowsePermission | undefined,
    callback: Callback<T>
  ): Promise<void>;
  /**
   * Returns a list of users who fulfill these criteria:
